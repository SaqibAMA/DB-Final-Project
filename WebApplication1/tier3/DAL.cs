...
namespace WebApplication1.tier3
{
    public class DAL
    {
        ...
        private static ConnectionStringSettings obj = ConfigurationManager.ConnectionStrings["DefaultConnection"];
        private static string connection_str = obj.ConnectionString;
